...
public class BoardAnalyzer {
    ...
    public static boolean isGameWon(char[][] board, char player) {
        for (int i = 0; i < 3; i++) {
            if (board[i][0] == player && board[i][2-1] == player && board[i][2-2] == player) {
                return true;
            }
        ...
        if (board[0][0] == player && board[1][2-1] == player && board[2][2-2] == player) {
            return true;
        }
        if (board[0][2] == player && board[1][2-1] == player && board[2][2-0] == player) {
            return true;
        }
        return false;
    }
